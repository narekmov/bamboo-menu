...
export const OrderModal = ({ isVisible, close, data }) => {
  ...
  const addHandler = useCallback((id, name, quantity, time, price) => {
        ...
        <View style={[styles.wrapper]}>
          <View style={styles.container}>
            <View style={styles.imageWrapper}>
              <Image source={{ uri: `${API}${data.image}` }} style={styles.image} />
            </View>
            <View style={styles.rightContent}>
              <View style={styles.topContent}>
                <View>
                  <Text style={styles.topContentTitleText}>{data.name[language]}</Text>
              ...
              <View style={styles.bottomContent}>
                ...
                <View style={styles.bottomContentRight}>
                  <Text style={styles.price}>{price * quantity}<Text style={styles.priceText}>AMD</Text></Text>
                  <TouchableOpacity
                    style={styles.bottomContentRightAdd}
                    onPress={() => addHandler(data._id, data.name, quantity, data.duration, price * quantity)}
                  >
